...
VENDOR_BLOBS ?= vendor/samsung/j7maxlte/j7maxlte-vendor.mk
$(call inherit-product-if-exists, $(VENDOR_BLOBS))

MTK_PROJECT_CONFIG ?= device/samsung/j7maxlte/ProjectConfig.mk
...
# Inherit the rest from mt6757-common
$(call inherit-product, device/cyanogen/mt6757-common/mt6757.mk)
